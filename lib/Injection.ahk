...
; -------------------------------------------------------------
; 翻译当前原文框文本 (Ctrl+T 触发): 原文保留, 译文显示在译文框
; -------------------------------------------------------------
TranslateCurrentText(*) {
    ...
    res := OpenRouterClient.TranslateText(rawText, AppConfig.TargetLanguage, AppConfig.ApiBase, AppConfig.ApiKey, AppConfig.Model, glossaryHint)
